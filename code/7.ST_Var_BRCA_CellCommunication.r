...
###############################读取空转数据################################
# data_dir<- "F:/Desktop/ST_data/spatial_transcriptome/data/melanoma/"
...
seurat_object <- readRDS("E:/数据库/STMut/数据处理/中间文件/MutSites_01_SeuratObject.rds")
spot_gene_mutcount_matrix <- read.table("E:/数据库/STMut/数据处理/中间文件/spot_gene_mutcount_matrix.txt", sep = "\t", header = T, check.names = F)
...
for(cluster_jj in unique(brain@meta.data$mut_cluster)){
  ...
  for(gene_jj in  gene_bridge){
    ...
    scale.factors = jsonlite::fromJSON(txt = 
                                         file.path("E:/数据库/STMut/数据处理/BRCA/GSE203612/GSM6177599/spatial", 'scalefactors_json.json'))
...
write.table(cluster_group_prob, "E:/数据库/STMut/数据处理/结果表格/cluster_group_prob.txt", sep = "\t", quote = F, row.names = F)
...
png("E:/数据库/STMut/数据处理/结果/BRCA/GSE203612/GSM6177599/send_mut_statistic.png", width = 1225, height = 650)
...
png("E:/数据库/STMut/数据处理/结果/BRCA/GSE203612/GSM6177599/send_GO_enrich.png", width = 1225, height = 650)
...
png("E:/数据库/STMut/数据处理/结果/BRCA/GSE203612/GSM6177599/send_sankeyPlot.png", width = 1225, height = 650)
...
png("E:/数据库/STMut/数据处理/结果/BRCA/GSE203612/GSM6177599/recieved_mut_statistic.png", width = 1225, height = 650)
...
png("E:/数据库/STMut/数据处理/结果/BRCA/GSE203612/GSM6177599/recieved_GO_enrich.png", width = 1225, height = 650)
...
png("E:/数据库/STMut/数据处理/结果/BRCA/GSE203612/GSM6177599/recieved_sankeyPlot.png", width = 1225, height = 650)
...
write.table(send_static, "E:/数据库/STMut/数据处理/结果表格/send_statistic.txt", sep = "\t", row.names = F, quote = F)
...
names(send_static_1) <- c("Mut_cluster", "interaction_type", "interaction_number", "sample", "dataset", "disease")
write.table(send_static_1, "E:/数据库/STMut/数据处理/结果表格/send_statistic.txt", sep = "\t", row.names = F, quote = F)
...
send_dotplot$sample <- "GSM6177599"
send_dotplot$dataset <- "GSE203612"
send_dotplot$disease <- "BRCA"

write.table(send_dotplot, "E:/数据库/STMut/数据处理/结果表格/send_dotplot.txt", quote = F, row.names = F, sep = "\t")
...
sankey_plot$sample <- "GSM6177599"
sankey_plot$dataset <- "GSE203612"
sankey_plot$disease <- "BRCA"

sankey_plot$nodes <- gsub("'", '"', sankey_plot$nodes)
sankey_plot$links <- gsub("'", '"', sankey_plot$links)

write.table(sankey_plot, "E:/数据库/STMut/数据处理/结果表格/send_sankey.txt", sep = "\t", quote = F, row.names = F)
...
names(reci_static_1) <- c("Mut_cluster", "interaction_type", "interaction_number", "sample", "dataset", "disease")
write.table(reci_static_1, "E:/数据库/STMut/数据处理/结果表格/recived_statistic.txt", sep = "\t", row.names = F, quote = F)
...
recived_dotplot$sample <- "GSM6177599"
recived_dotplot$dataset <- "GSE203612"
recived_dotplot$disease <- "BRCA"

write.table(recived_dotplot, "E:/数据库/STMut/数据处理/结果表格/recived_dotplot.txt", quote = F, row.names = F, sep = "\t")
...
write.table(sankey_plot, "E:/数据库/STMut/数据处理/结果表格/recived_sankey.txt", sep = "\t", quote = F, row.names = F)
